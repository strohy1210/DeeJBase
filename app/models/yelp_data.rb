class YelpData
  ...
  def yelp_search(venue)
    ...
    save_attributes(venue, yelp_venue)
  end
  ...
  def save_attributes(venue, yelp_venue)
    ...
    venue.update(cross_streets: cross_streets, neighborhood: neighborhood, phone: phone, name: name, yelp_rating: yelp_rating, image_url: image_url, address: address, latitude: latitude, longitude: longitude)
  end
end